...
var FD_STR = {
    en: {
        ...
        unzipAfter: 'Expand the archive on the device after it arrives',
        unzipOnlyZip: 'Available only when every selected file is a .zip, .7z or .rar archive.',
        unzipNeeds7z: 'Formats other than .zip need 7-Zip installed on the device; where it is missing, the archive is left as it is and the reason appears in the server log.',
        unzipNote: 'The archive is expanded into a folder next to it, named after the archive. Windows only. The archive itself stays in place.',
    ...
    ru: {
        ...
        unzipAfter: 'Разархивировать на устройстве после раздачи',
        unzipOnlyZip: 'Доступно, только если все выбранные файлы — архивы .zip, .7z или .rar.',
        unzipNeeds7z: 'Для форматов кроме .zip на устройстве нужен установленный 7-Zip; где его нет, архив останется как есть, а причина попадёт в лог сервера.',
        unzipNote: 'Архив распаковывается в папку рядом с ним, названную по имени архива. Только Windows. Сам архив остаётся на месте.',
